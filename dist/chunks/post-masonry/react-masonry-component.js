...
function Blog(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: classnames__WEBPACK_IMPORTED_MODULE_0___default()('is-masonry', `uagb-post__columns-${columns}`, `uagb-post__columns-tablet-${tcolumns}`, `uagb-post__columns-mobile-${mcolumns}`, 'uagb-post__items')
  ...
  }, Object(_function__WEBPACK_IMPORTED_MODULE_3__["renderPostLayout"])('uagb/post-masonry', post, layoutConfig, props.attributes, props.categoriesList))))))), paginationRender());
}
