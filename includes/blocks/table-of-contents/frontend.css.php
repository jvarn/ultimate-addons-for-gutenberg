...
$top_padding    = ( isset( $attr['topPadding'] ) || ! empty( $attr['topPadding'] ) ) ? $attr['topPadding'] : $attr['vPaddingDesktop'];
$bottom_padding = ( isset( $attr['bottomPadding'] ) || ! empty( $attr['bottomPadding'] ) ) ? $attr['bottomPadding'] : $attr['vPaddingDesktop'];
$left_padding   = ( isset( $attr['leftPadding'] ) || ! empty( $attr['leftPadding'] ) ) ? $attr['leftPadding'] : $attr['hPaddingDesktop'];
$right_padding  = ( isset( $attr['rightPadding'] ) || ! empty( $attr['rightPadding'] ) ) ? $attr['rightPadding'] : $attr['hPaddingDesktop'];

$mobile_top_padding    = ( isset( $attr['topPaddingMobile'] ) || ! empty( $attr['topPaddingMobile'] ) ) ? $attr['topPaddingMobile'] : $attr['vPaddingMobile'];
$mobile_bottom_padding = ( isset( $attr['bottomPaddingMobile'] ) || ! empty( $attr['bottomPaddingMobile'] ) ) ? $attr['bottomPaddingMobile'] : $attr['vPaddingMobile'];
$mobile_left_padding   = ( isset( $attr['leftPaddingMobile'] ) || ! empty( $attr['leftPaddingMobile'] ) ) ? $attr['leftPaddingMobile'] : $attr['hPaddingMobile'];
$mobile_right_padding  = ( isset( $attr['rightPaddingMobile'] ) || ! empty( $attr['rightPaddingMobile'] ) ) ? $attr['rightPaddingMobile'] : $attr['hPaddingMobile'];

$tablet_top_padding    = ( isset( $attr['topPaddingTablet'] ) || ! empty( $attr['topPaddingTablet'] ) ) ? $attr['topPaddingTablet'] : $attr['vPaddingTablet'];
$tablet_bottom_padding = ( isset( $attr['bottomPaddingTablet'] ) || ! empty( $attr['bottomPaddingTablet'] ) ) ? $attr['bottomPaddingTablet'] : $attr['vPaddingTablet'];
$tablet_left_padding   = ( isset( $attr['leftPaddingTablet'] ) || ! empty( $attr['leftPaddingTablet'] ) ) ? $attr['leftPaddingTablet'] : $attr['hPaddingTablet'];
$tablet_right_padding  = ( isset( $attr['rightPaddingTablet'] ) || ! empty( $attr['rightPaddingTablet'] ) ) ? $attr['rightPaddingTablet'] : $attr['hPaddingTablet'];
